        ...
        private void comboBox1_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            ...
            if (StreetBox.Text == "Pay Methods")
            {
                ...
                while (length > count)
                {
                    ...
                    this.chart2.Series["Lift"].Points.AddXY("Contant", item1);
        ...
        private void Search2_Click(object sender, EventArgs e)
        {
            ...
            if (ParkinglotTxt.Visible == true)
            {
                ...
                else if(StreetBox.SelectedIndex == 0)
                {
                        ...
                        DBConnect Database = new DBConnect();
                        List<string>[] list = Database.Select("parkeergarage3", "", Keuze1.Text, keuze3.Text, "", "", "Hoeeveelheid_Diensten");
                        int length = list[1].Count;
                        int count = 0;
                ...
                else if (StreetBox.SelectedIndex == 2)
                {
                    ...
                    DBConnect Database = new DBConnect();
                    List<string>[] list = Database.Select("parkeergarage3", "", Keuze1.Text, keuze3.Text, "", "", "Hoeveelheid+Betaalmogelijkheden");
                    int length = list[1].Count;
                    int count = 0;
                    this.chart2.Visible = true;
                    while (length > count)
            ...
            {
                dataset = "straat";
                if (StreetBox.SelectedText  == "Bouwjaar")
                {
